\section{Shadow \ac{DOM}}\label{shadow-dom}
...
\subsection{Shadow \ac{DOM} nach \ac{W3C}}\label{shadow-dom-nach-w3c}
...
\subsection{Styling mit \ac{CSS}}\label{styling-mit-css}
...
\subsection{Styling des Shadow \ac{DOM} von außerhalb}\label{styling-des-shadow-dom-von-ausserhalb}
...
\subsection{\ac{CSS}-Variablen}\label{css-variablen}
...
\subsection{Beispiel eines Shadow \ac{DOM}s mit Template und \ac{CSS}}\label{beispiel-eines-shadow-doms-mit-template-und-css}
