...
Sie besteht aus vielen geschachtelten \texttt{\textless{}div\textgreater{}}-Elementen. Die Probleme dieser Struktur sind deutlich: Es ist sehr schwer zu erkennen, welches Element was darstellt und welche Funktion hat. Abgesehen von der fehlenden schnell ersichtlichen Semantik - also der Zuordnung der Bedeutung zu einem Element - ist die Applikation nur schwer wartbar.
...
\lstinputlisting[float,floatplacement=H,language=HTML,label=beamwc,caption=Beispiel einer Applikation mit Web Components]{kapitel2/listings/2-1.html}
