...
Die von Google entwickelte Library ``Polymer'' setzt auf diese Technologien auf und soll den Umgang mit ihnen vereinfachen sowie sie auf ältere Browser portieren. Sie ermöglicht es, gekapselte Komponenten zu entwickeln, welche wiederum von Komponenten verwendet oder mit anderen Komponenten verbunden werden können. Dies ermöglicht die Realisierung komplexer Applikationen.
