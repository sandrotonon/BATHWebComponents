...
\noindent\textit{Diese Komponente ist ebenfalls zu finden auf:}

\begin{itemize}[noitemsep,nolistsep,leftmargin=0pt]
  \item[] \textbf{GitHub} https://github.com/glur4k/multi-navigation-app
  \item[] \textbf{customelements.io} https://customelements.io/glur4k/multi-navigation-app/
\end{itemize}

\noindent\textit{und kann mittels Bower} \texttt{bower install multi-navigation-app`} \textit{heruntergeladen \mbox{werden}.}
